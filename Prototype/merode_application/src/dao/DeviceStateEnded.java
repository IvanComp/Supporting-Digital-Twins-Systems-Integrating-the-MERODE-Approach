 ...
 */
public class DeviceStateEnded extends DeviceState {

    public static DeviceStateEnded getObject (org.hibernate.Session sess) throws org.hibernate.HibernateException {
	    DeviceStateEnded state = null;
	    // Search in database
	    java.util.Collection states = findStateByName (sess, "ended");
	    if ( states != null && !states.isEmpty() )
	        state = (DeviceStateEnded)states.iterator().next();
	    if ( state == null ) {
	        state = new DeviceStateEnded();
	        // Save in database
	        sess.save (state);
	    }
	    return state;
