 ...
 */
public abstract class FeatureofinterestOperationWindow extends JFrame {
    ...
    public FeatureofinterestOperationWindow (MerodeMainEventHandlerGui main_f, 
    				MerodeMainEventHandler main_h, 
    					ObjectListWindow list_f, 
    						String b_name) {
        super("Featureofinterest: " + b_name);
        main_frame = main_f;
        main_handler = main_h;
        list_frame = list_f;
        button_name = b_name;
