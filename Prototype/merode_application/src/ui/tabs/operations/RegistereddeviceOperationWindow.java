 ...
 */
public abstract class RegistereddeviceOperationWindow extends JFrame {
    ...
    public RegistereddeviceOperationWindow (MerodeMainEventHandlerGui main_f, 
    				MerodeMainEventHandler main_h, 
    					ObjectListWindow list_f, 
    						String b_name) {
        super("Registereddevice: " + b_name);
        main_frame = main_f;
        main_handler = main_h;
        list_frame = list_f;
        button_name = b_name;
