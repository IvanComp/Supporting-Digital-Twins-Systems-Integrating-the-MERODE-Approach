...
import ui.tabs.operations.FeatureofinterestOperationWindow;
...
public class FeatureofinterestmecrfeatureofinterestWindow extends FeatureofinterestOperationWindow {
    
    public FeatureofinterestmecrfeatureofinterestWindow (MerodeMainEventHandlerGui main_frame, MerodeMainEventHandler main_handler, ObjectListWindow list_frame) {
        super(main_frame, main_handler, list_frame, "mecrfeatureofinterest");
    ...
    protected void executeMethod() {
        try {
            ...
            if (hasErrors) {
                ...
                boolean success = main_handler.mecrfeatureofinterest (
                t_Name.getText());
                if (success){
