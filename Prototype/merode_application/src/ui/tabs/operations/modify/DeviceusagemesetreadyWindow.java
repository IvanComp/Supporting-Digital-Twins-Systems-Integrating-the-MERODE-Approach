 ...
 */
public class DeviceusagemesetreadyWindow extends DeviceusageOperationWindow {
    private dao.Deviceusage object;

    public DeviceusagemesetreadyWindow (MerodeMainEventHandlerGui main_frame, 
    		MerodeMainEventHandler main_handler, 
    			ObjectListWindow list_frame, 
    				dao.Deviceusage obj) {
        super(main_frame, main_handler, list_frame, "mesetready");
        object = obj;
    ...
    protected void executeMethod() {
        try {
            ...
            if (hasErrors) {
                ...
                main_handler.mesetready (object.getId(), 
                							t_Name.getText());
